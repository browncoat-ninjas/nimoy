...
class TestSpecMetadata(unittest.TestCase):
    def test_setters(self):
        ...
        spec_metadata.add_test_method('the_method2')
        spec_metadata.add_method_block('the_method', 'block_type')
        spec_metadata.add_method_variable_value('the_method', 'a', 1)
        spec_metadata.add_method_variable_values('the_method2', 'b', [1, 2])
        ...
        self.assertEqual(spec_metadata.methods[1], 'the_method2')
        self.assertEqual(spec_metadata.method_blocks['the_method'][0], 'block_type')
        self.assertEqual(spec_metadata.method_variables['the_method']['a'], [1])
        self.assertEqual(spec_metadata.method_variables['the_method2']['b'], [1, 2])
